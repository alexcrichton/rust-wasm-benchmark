...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "bm_stdweb.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "bm_stdweb.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'bm_stdweb'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'bm_stdweb':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        ...
        initialize: function( instance ) {
            ...
            Module.exports.call_js_thunk_n_times = function call_js_thunk_n_times(n) {
    Module.instance.exports.call_js_thunk_n_times(Module.STDWEB_PRIVATE.prepare_any_arg(n));
}
;
                Module.exports.call_js_add_n_times = function call_js_add_n_times(n, a, b) {
    Module.instance.exports.call_js_add_n_times(Module.STDWEB_PRIVATE.prepare_any_arg(n), a, b);
}
;
                Module.exports.thunk = function thunk() {
    Module.instance.exports.thunk();
}
;
